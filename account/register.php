...
$em=$email;
 $subject="Welcome to Goldbankus";
$mes = "Dear $user ,
Welcome to Hopes Insurance - ACCOUNT NUMBER($accn)
ACCOUNT NUMBER:$accn


You can login with your account number and password at
www.hopesinsurance.com/login.php
...
echo "";   
  ...
  echo "<div class='alert alert-success'>Creation Successful, redirecting in 5 seconds.....  you can also  <a href='login.php'>click to login</a></div>";
}
