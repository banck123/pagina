...
<html lang="en" style="height: 100%;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>
   Admin Dashboard    - Credit Cards, Banking, Loans and Mobile Payments
  </title>
...
<body class="" style="position: relative; min-height: 100%; top: 0px;">
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
     ...
     <img alt="" src="./file/admin.jpg">        </span>
            </div>
          </a>
          <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
            <div class=" dropdown-header noti-title">
              <h6 class="text-overflow m-0">Welcome <?php echo $_SESSION['u2'];  ?>!</h6>
            </div>
...
/* ]]> */
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" href="?ah">
                <i class="fas fa-book" style="font-size:18px;color:black"></i>DR/CR Transaction History
            </a>
          </li>
          
           <li class="nav-item">
            <a class="nav-link" href="?delam">
                <i class="fas fa-window-close" style="font-size:18px;color:black"></i>Delete Account
            </a>
          </li>
            
              <li class="nav-item">
            <a class="nav-link" href="?cre">
                <i class="fas fa-plus" style="font-size:18px;color:black"></i>Credit User
            </a>
          </li>
             <li class="nav-item">
            <a class="nav-link " href="?deb">
                 <i class="fas fa-minus" style="font-size:18px;color:black"></i>Debit User
            </a>
          </li>
		  
		   <li class="nav-item">
            <a class="nav-link " href="logout.php">
                 <i class="fas fa-lira-sign" style="font-size:18px;color:black"></i>Logout
            </a>
          </li>
 ...
 <!---begin of Mobile View Here   only from Digital Forest Team-->
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      ...
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="?profile">Welcome: Bank Manager <?php echo $_SESSION['u2'];  ?></a>
        ...
        <ul class="navbar-nav align-items-center d-none d-md-flex">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
              ...
              <div class="dropdown-divider"></div>
              <a href="logout.php" class="dropdown-item">
                  <i class="fa fa-sign-out" style="font-size:18px;color:black"></i> 
                <span>Logout</span>
              </a>
            </div>
          </li>
...
include("user.php");
          ...
          <div class="card shadow">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                ...
                <a href="?cre" class="btn btn-sm btn-success">Credit Customer</a>
                <a href="?deb" class="btn btn-sm btn-warning">Debit Customer</a>
       ...
       <footer class="footer">
          ...
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              © 2021 Copyright: <a href="https://prepayandassociateservices.com/dashboard/admin/index.php" class="font-weight-bold ml-1" target="_blank"> Margon Banking Script </a>
            </div>
          </div>
  ...
  <script src="./file/t.js.download"></script><div id="chart-tooltip" class="popover bs-popover-top" role="tooltip" style="top: 438.2px; left: 610.199px; display: none; z-index: 100;"><div class="arrow"></div><h3 class="popover-header text-center">Aug</h3><div class="popover-body d-flex align-items-center justify-content-center"><span class="badge badge-dot"><i class="bg-primary"></i></span><span class="popover-body-value">$30k</span></div></div>
  <script>
    window.TrackJS &&
      TrackJS.install({
  ...
  </script><div id="goog-gt-tt" class="skiptranslate" dir="ltr"><div style="padding: 8px;"><div><div class="logo"><img src="./file/translate_24dp.png" width="20" height="20" alt="Google Translate"></div></div></div><div class="top" style="padding: 8px; float: left; width: 100%;"><h1 class="title gray">Original text</h1></div><div class="middle" style="padding: 8px;"><div class="original-text"></div></div><div class="bottom" style="padding: 8px;"><div class="activity-links"><span class="activity-link">Contribute a better translation</span><span class="activity-link"></span></div><div class="started-activity-container"><hr style="color: #CCC; background-color: #CCC; height: 1px; border: none;"><div class="activity-root"></div></div></div><div class="status-message" style="display: none;"></div></div>
